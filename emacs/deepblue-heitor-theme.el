...
(custom-theme-set-faces
 ...
 '(region ((t (:weight normal :underline nil :inverse-video nil :foreground "dark blue" :background "gold"))))
 ...
 '(mode-line-buffer-id ((t (:foreground "black" :underline nil :weight normal))))
