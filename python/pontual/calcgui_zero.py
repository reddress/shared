...
class Application(tk.Frame):
    ...
    def createWidgets(self):
        ...
        self.label3 = tk.Label(text="1%").grid(row=2, column=0)
        self.twentyone = tk.Entry(width=9)
        self.twentyone.grid(row=2, column=1)

        self.label4 = tk.Label(text="2%").grid(row=3, column=0)
        self.twentytwo = tk.Entry(width=9)
        self.twentytwo.grid(row=3, column=1)

        self.label5 = tk.Label(text="3%").grid(row=4, column=0)
    ...
    def update_values(self, event):
        ...
        self.twentyone.delete(0, len(self.twentyone.get()))
        self.twentyone.insert(0, '{0:.4f}'.format(roundup(x, '29700')))

        self.twentytwo.delete(0, len(self.twentytwo.get()))
        self.twentytwo.insert(0, '{0:.4f}'.format(roundup(x, '29400')))
        ...
        self.twentyonemult.delete(0, len(self.twentyonemult.get()))
        self.twentyonemult.insert(0, '{0:.4f}'.format(roundupmult(x, m, '29700')))

        self.twentytwomult.delete(0, len(self.twentytwomult.get()))
        self.twentytwomult.insert(0, '{0:.4f}'.format(roundupmult(x, m, '29400')))
